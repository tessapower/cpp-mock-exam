...
Class templates are similar to function templates, but they define generic classes. They're the foundation of the entire STL - `std::vector`, `std::map`, `std::string`, etc. are all class templates!

### Basic Class Template

**Why Class Templates?**

Imagine you need a simple container that holds a single value. Without templates:
